...
(
    responsible_rut
) REFERENCES residence.responsible
(
    rut
),
    PRIMARY KEY
...
(
    rut
) REFERENCES residence.medical_record
(
    rut
),
    PRIMARY KEY
...
(
    ...
    disease_name,
    prescription_date
) REFERENCES residence.diagnostic
(
    rut,
    disease_name,
    prescription_date
...
(
    medication_name
) REFERENCES residence.medication
(
    medication_name
),
    PRIMARY KEY
